...
#
# An IP address consists of 4 numbers, separated from each other will a full stop. But
...
#
# This challenged is inteded to practise for loops and if/else statements, so although
# you could use other techniques (such as spltting the string up), that's not the
...
# unless final character in the string was a . then we have not printed the last segment
# if character != '.':
#     print("segment {} contains {} characters".format(segment, segmentLength))
